"""
SQLModel Models Template for Rice Export FSMS (ISO 22001:2018)

This template provides the complete Document and Task models with:
...
from sqlmodel import SQLModel, Field, Relationship, Column, String, Text, CheckConstraint
